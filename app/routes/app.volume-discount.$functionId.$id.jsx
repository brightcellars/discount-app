...
export const loader = async ({ params, request }) => {
  ...
  const configuration = JSON.parse(
    responseJson.data.discountNode.metafield ?? null
  );
              ...
              <Card>
                <VerticalStack gap="3">
                  ...
                  <Text variant="bodyMd" as="p">
                    This is currently applying discount to the following products:
                  </Text>
                  <li>
                    Membership box
                  </li>
                  <li>
                    [if user is member] 20% OFF of all products except the ones with the "Don't Show Member Price" tag
                  </li>
                  <li>
                    SOTM (Sip of the Month)
                  </li>
                  <li>
                    Build-a-bundle box
                  </li>
                  <Text variant="bodyMd" as="p">
                    If you wish to update these rules or add new rules, please contact a developer.
                  </Text>
                </VerticalStack>
              </Card>
            </VerticalStack>
